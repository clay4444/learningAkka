...
import org.clay.message.{NginxRecord, RawNginxRecord, Registration}
...
/**
  * 用来模拟发送日志记录消息的Actor,模拟向各个collector角色的节点发送消息
  */
